...
*------------------------------------------------------------------------------
* $Revision:   1.1  $
* $Modtime:   Aug 12 2005 16:32:18  $
* $Log:   //mtkvs01/VMDATA/HWTest/archives/comm/Thread.h-arc  $
 * 
...
*==============================================================================
*******************************************************************************/
#ifndef ANGUS_THREAD_DEF_H
#define ANGUS_THREAD_DEF_H
...
public:
	AThread();
	// Iverwrute this virtual function to do the clean job
	virtual ~AThread();

	// Call this function to start the thread
	bool StartThread();
	// Call this function to wait the thread stop
	void WaitForExit();
...
protected:
	// The thread function
	// In this function, it's legal to use any member data of 
	// this class.
