...
//#define __ATA_MT6795_SMT__
	...
	{
		bool	b_LCD = false;
		bool    b_slpmode = false;
		bool	b_Camera = false;
		bool    b_Camera_Main2 = false;
		bool    b_Camera_Sub = false;
		bool	b_Vibrator = false;
		bool	b_Charging = false;
		bool	b_Keypad = false;
		bool	b_TouchScr = false;
		bool    b_CMMB = false;
		bool	b_RTC = false;
		bool    b_ADC = false;
		bool    b_LED = false;
		...
		bool    b_Flash = false;
		bool	b_SIM = false;
		bool	b_Barcode = false;
		bool	b_SWVersion = false;
		bool	b_HWVersion = false;

		bool	b_Speaker = false;
		bool	b_Receiver = false;
		bool	b_EarchPhone = false;
		bool	b_FM = false;

		bool    b_gsensor = false;
		bool    b_msensor = false;
		bool    b_alsps = false;
		bool    b_gyroscope = false;

		bool    b_micbias = false;
		bool    b_OTG = false;
		bool    b_HDMI = false;
		bool    b_MHL = false;
		bool    b_RSSI = false;
		bool    b_offMode = false;
		bool    b_UsbTypeC = false;
		bool 	b_Humidity = false;
		bool	b_Barometer = false;
		bool 	b_BTS = false;
		bool	b_ExtBuck = false;
		bool	b_FingerPrint = false;
		bool	b_NFC = false;
		bool b_PUMP = false;
		bool  b_IMEI = false;
		bool    b_Voltage = false;
		bool    b_ACC = false;
		bool    b_SOS = false;
		bool    b_Gsensoreint = false;
		bool    b_Reset = false;
		bool    b_Relay = false;
		bool    b_Cflag = false;
		bool    b_Comport = false;
		bool    b_Power = false;
		bool    b_SENSORIRDA = false;
		bool    b_SelectIB = false;
		bool    b_SelectAll1 = false;
		bool    b_SelectAll2 = false;
		bool    b_SelectAll3 = false;
		bool    b_SelectAll4 = false;
		bool    b_aging = false;
		bool    b_boardflag = false;
		bool    b_machineflag = false;
		bool    b_board = false;
		bool    b_unaged = false;
		bool    b_aged = false;
		bool    b_writeflag = false;
		bool    b_scanwifiadd = false;
		bool    b_scanbtadd = false;
		bool    b_hwd = false;
	...
	typedef enum
	{
		MODE_CONNECT_BROM_NOSECURITY = 0,
		MODE_CONNECT_BROM_SECURITY,
		MODE_CONNECT_PRELOADER_NOSECURITY
	}E_ATA_CONNECT_STATE;
	...
	typedef struct
	{
	   ...
	   // ftm_ata_emmc emmc;
		ftm_ata_gpsdata  gps_snr;
		ftm_ata_voltage voltage;
		ftm_ata_gsensoreint gsensoreint;
		ftm_ata_acc acc;
		ftm_ata_sos sos;
#ifdef __ATA_LOAD30_TEST20__
		ftm_ata_rf rf;
	...
	typedef void(__stdcall *Callbackcamera)(int handle_index, E_ATDLL_TEST_ITEM_COUNT test_item);//lxw add
	typedef struct
	{
		char   log_file[256];
		...
		char   scan_barcode[128];

		char   auth_path[256];
		//char   scert_path[256];
		bool    ishandtest;  //added  lxw
		...
		char	MainCameraFilePath[60];
		char	AHDCameraFilePath[60];
		...
		bool    showpiconetwo;
		bool    showpictwotwo;
		Callbackcamera  cbcamerapro;//lxw  add
		bool    imei_barcode_selected;
		char    scan_imei[32];	 //added  lxw
...
#define MAX_BT_LIST 20
	typedef struct
	{
		char			bt_addr[16];   /*zishuo20150727*/
...
#define ATA_DLL_SIM_NUM_MAX		4
	...
	{
		int	port_state;
	} S_ATADLL_COMPORT_CNF;
	typedef struct
	{
		float  dbvalue;
	}S_ATADLL_SPEAKER_CNF;
	...
	typedef struct
	{
		...
		S_ATADLL_OFFMODE_CNF pump_cnf;
		S_ATADLL_ACC_CNF	acc_cnf;
		S_ATADLL_VOLTAGE_CNF       voltage_cnf;
		S_ATADLL_GSENSOREINT_CNF       gsensoreint_cnf;
		S_ATADLL_SOS_CNF	sos_cnf;
		S_ATADLL_COMPORT_CNF comport_cnf;
		S_ATADLL_SPEAKER_CNF   speaker_cnf;
		S_ATADLL_AGING_CNF   aging_cnf;
		S_ATADLL_TESTFLAG_CNF   testflag_cnf;
		S_ATADLL_HWD_CNF       hwd_cnf;
	...
	typedef struct
	{
		...
		S_ATADLL_PUMP_SPEC       pump_spec;
		S_ATADLL_SPEAKER_SPEC    speaker_spec;
		S_ATADLL_IMEI_SPEC		imei_spec;
		S_ATADLL_VOLTAGE_SPEC	voltage_spec;
		S_ATADLL_AGE_SPEC	aging_spec;
	...
	E_ATADLL_RESULT __stdcall ATADLL_WriteScanBarcodeToTarget(const int ata_handle);
